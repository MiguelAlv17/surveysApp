...
const handleSubmit = async () => {
    ...
    try {
        const response = await addDvr(formData);
...
<template>
    ...
    <div >
        <ContainerCustom title="Agregar DVR" subtitle="Formulario para agregar nuevo DVR" icon="video_call">
